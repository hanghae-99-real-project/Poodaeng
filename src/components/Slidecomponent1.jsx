...
//     setCurrentImgOrder(currentImgOrder + 1); // 다음 이미지로 이동하기 위해 currentImgOrder 값을 증가시킵니다.
//   };

//   const moveToPrevSlide = () => {
//     if (currentImgOrder === 0) return; // 이미지 순서가 첫 번째 이미지인 경우, 더 이상 이동하지 않습니다.
//     setCurrentImgOrder(currentImgOrder - 1); // 이전 이미지로 이동하기 위해 currentImgOrder 값을 감소시킵니다.
//   };
...
//       moveToNextSlide();
//       console.log('화면넘어감');
//     }, 5000); // 5000ms마다 moveToNextSlide 함수가 호출되도록 합니다.
...
//                 />
//                 <div className='font-bold text-sm'>{item.address}</div>
//               </div>
//             );
//           })}
//         </div>
